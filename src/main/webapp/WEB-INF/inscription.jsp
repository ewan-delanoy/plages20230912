...
<form:form method="post" modelAttribute="nouveauClient" action="inscription">
...
<div class="col-sm-1 control-label"></div><form:button class="btn btn-success">Inscription</form:button>
</form:form>
